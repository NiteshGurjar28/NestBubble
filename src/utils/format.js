...
/**
 * Format a date in Indian format (e.g., 03/09/2025 or 3 September 2025)
 * @param {string|Date} value - The date to format
 * @param {Object} [options] - Formatting options
 * @param {string} [options.format="short"] - Format type: short, long, full, compact, custom
 * @param {Object} [options.customFormat] - Custom Intl.DateTimeFormat options
...
/**
 * Format a date and time in Indian format (e.g., 15 Jul 2025, 12:02 pm)
 * @param {string|Date} value - The date/time to format
 * @param {Object} [options] - Formatting options
 * @param {string} [options.format="medium"] - Format type: medium, full, custom
 * @param {Object} [options.customFormat] - Custom Intl.DateTimeFormat options
